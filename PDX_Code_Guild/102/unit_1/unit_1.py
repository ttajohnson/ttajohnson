...
while True:
    ...
    if user == computer: #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! variable name users undefined typo, changed to user
        print("Looks like a tie") #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! print function was not closed with )
    ...
    # check all cases if user is rock
        ...
        # check losing case
        elif computer == "paper": #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! losing case for rock defined as rock, changed to paper
    ...
    # check all cases if user is paper
        ...
        # check winning case
        if computer == "rock": #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! missing : for start of code block
            print("You win!")
    ...
    # check all cases if user is scissors
        ...
        # check losing case
            ...
            print("Sorry, You lose.") #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! print function was capitalized, changed to lowercase p
